...
#'
#' @description Evaluates predictive value of a common variable \code{x} with respect to a specific variable \code{y}, in the context of statistically matching two independent files.
